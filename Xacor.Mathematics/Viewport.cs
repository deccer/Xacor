...
namespace Xacor.Mathematics
{
    ...
    public struct Viewport : IEquatable<Viewport>
    {
        ...
        public static unsafe implicit operator RawViewport(Viewport value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static unsafe implicit operator RawViewportF(Viewport value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static unsafe implicit operator Viewport(RawViewport value)
        {
